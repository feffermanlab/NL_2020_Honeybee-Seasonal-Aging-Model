...
% Version that analyses forager parameters
...
run(seasonFile);
run('eigenvalueHelper_NLedit.m');   % this code finds the new eigenvalue for every value of param of interest

% e_vector stores the resulting eigenvalues
%rename e_vector so it can be accessed after code is run
spring_e_vector = e_vector; %vector containing eigenvalues for each value of param of interest
